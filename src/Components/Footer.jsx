      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm mb-6">
            Heatz is a registered brand of Ashtel group. It is registered in different countries
          ...
          <div className="mb-4">
            ...
            />
            <button className="text-green-500 text-xl ml-2"><BsSend /></button>
          </div>
          <div className="flex items-center text-sm">
            <input type="checkbox" className="mr-2" />
            <span>
              I confirm acceptance of the <a href="#" className="text-green-500 underline">Privacy Policy</a> and consent
